    ...
    <form action="aksi-edit-faskes.php" method="post">
        ...
        <table>
            <?php
                ...
                $qedit = mysqli_query($conn,"select * from faskes where idfaskes = '".$idfaskes."'");
                while ($d = mysqli_fetch_array($qedit)) {
                    # code...
?>
            <tr>
                <td>ID Faskes</td>
                <td><input type="text" name="idfaskes" value="<?php echo $d['idfaskes']; ?>" id="" required="required" readonly></td>
            </tr>
            <tr>
                <td>Nama Faskes</td>
                <td><input type="text" name="namafaskes" value="<?php echo $d['namafaskes']; ?>" id="" required="required"></td>
            </tr>
            <tr>
...
?>
        <form action="edit-faskes.php" method="get">
...
if (isset($_GET['cari'])) {
    ...
    $query = mysqli_query($conn,"select * from faskes where ".$berdasarkan." like '%".$cari."%'");
